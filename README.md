...
- Based on a **Dev Container-friendly Ubuntu 24.04 LTS base image** using [devcontainers/base:noble](https://mcr.microsoft.com/en-us/artifact/mar/devcontainers/base/tag/noble).
